...
export default {
    ...
    methods: {
        async getContracts() {
            try {
                const response = await axios.get("https://35.196.173.137:8080/contracts");
        ...
        async getClients() {
            try {
                const response = await axios.get("https://35.196.173.137:8080/clients");
        ...
        async filtrar() {
            try {
                ...
                const response2 = await axios.post("https://35.196.173.137:8080/filter/" + data);
                // this.desde = "";
                // this.hasta = "";
